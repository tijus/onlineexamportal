...
public class MyListener implements ServletContextListener{
	...
	try{
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/onlineExam","sandeep2341995","sandeep");
		...
		PreparedStatement ps2= con.prepareStatement("CREATE SEQUENCE JAVAPOINT MINVALUE 1 MAXVALUE 999999999 INCREMENT BY 1 START WITH 1 NOCACHE NOORDER NOCYCLE");
		ps2.executeUpdate();
