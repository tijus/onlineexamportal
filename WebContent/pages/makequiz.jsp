...
%>
  		...
  		<form method="post" action="createquiz1.jsp" >
					...
					<tr><td><b>Quiz Title:</b></td><td><input type="text" name="quizname" /></td></tr>
<!-- 					<tr><td>quizid:</td><td><input type="text" name="qid" /></td></tr> -->
                    <tr><td></td><td><button class="btn btn-lg btn-default">Create quiz</button></td>
                     	</table>
                     </form> </div>
