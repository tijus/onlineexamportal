    ...
    <div class="box col-md-12">
        <div class="box-inner">
            ...
            <div class="box-content row">
                <div class="col-lg-12">
                    <div class="header"><h1>Book your slot</h1> <hr></div><br>
                    
                    <div class="contents" style="padding:0 35% 5% 15%;">
                      <form role="form" action="processOtp.jsp">
                      <jsp:include page="countries.jsp"></jsp:include>
						  ...
						  <div class="form-group">
						   <label for="country">Select Subject:</label>
			  			  ...
			  			  <div align="right">
						  <button type="submit" class="btn btn-danger"><span class="glyphicon glyphicon-cog"></span> Generate OTP</button>
						  </div>
						</form>
